...
function Header() {
  return (
    <header className="bg-gradient-to-tr from-orange-600 to-fuchsia-400">
      ...
      <div className="flex flex-col justify-between gap-12 items-center pt-20 pb-28">
        <div className="flex flex-col gap-2 items-center">
          ...
          <h2 className="text-transparent bg-clip-text bg-gradient-to-tr from-orange-200 to-fuchsia-200 font-extrabold text-6xl uppercase text-center max-w-[13em]">
        ...
        <div className="flex flex-col items-center gap-7">
          ...
          <div className="flex flex-row gap-3">
            <Link href="">
              <Button
                variant="secondary"
                className="flex items-center text-orange-900 w-[170px] cursor-pointer hover:bg-orange-100 transition-all"
              >
                <RiDashboardFill />
                Dashboard
              </Button>
